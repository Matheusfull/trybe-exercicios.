...
function convert1(value, base, conversion) {
    if (base === 'km' && conversion === 'm')
        return value * 1000;
    if (base === 'hm' && conversion === 'm')
        return value * 100;
    if (base === 'dam' && conversion === 'm')
        return value * 10;
    if (base === 'm' && conversion === 'm')
        return value * 1;
    if (base === 'dm' && conversion === 'm')
        return value * 0.1;
    if (base === 'cm' && conversion === 'm')
        return value * 0.01;
    if (base === 'mm' && conversion === 'm')
        return value * 0.001;
    if (base === 'km' && conversion === 'dam')
        return value * 100;
    if (base === 'hm' && conversion === 'dam')
        return value * 10;
    if (base === 'dam' && conversion === 'dam')
        return value * 1;
    if (base === 'm' && conversion === 'dam')
        return value * 0.1;
    if (base === 'dm' && conversion === 'dam')
        return value * 0.01;
    if (base === 'cm' && conversion === 'dam')
        return value * 0.001;
    if (base === 'mm' && conversion === 'dam')
        return value * 0.0001;
    if (base === 'km' && conversion === 'hm')
        return value * 10;
    if (base === 'hm' && conversion === 'hm')
        return value * 1;
    if (base === 'dam' && conversion === 'hm')
        return value * 0.1;
    if (base === 'm' && conversion === 'hm')
        return value * 0.01;
    if (base === 'dm' && conversion === 'hm')
        return value * 0.001;
    if (base === 'cm' && conversion === 'hm')
        return value * 0.0001;
    if (base === 'mm' && conversion === 'hm')
        return value * 0.00001;
    if (base === 'km' && conversion === 'km')
        return value * 1;
    if (base === 'hm' && conversion === 'km')
        return value * 0.1;
    if (base === 'dam' && conversion === 'km')
        return value * 0.01;
    if (base === 'm' && conversion === 'km')
        return value * 0.001;
    if (base === 'dm' && conversion === 'km')
        return value * 0.0001;
    if (base === 'cm' && conversion === 'km')
        return value * 0.00001;
    if (base === 'mm' && conversion === 'km')
        return value * 0.000001;
    if (base === 'km' && conversion === 'dm')
        return value * 0.0001;
    if (base === 'hm' && conversion === 'dm')
        return value * 0.001;
    if (base === 'dam' && conversion === 'dm')
        return value * 0.01;
    if (base === 'm' && conversion === 'dm')
        return value * 0.1;
    if (base === 'dm' && conversion === 'dm')
        return value * 1;
    if (base === 'cm' && conversion === 'dm')
        return value * 0.1;
    if (base === 'mm' && conversion === 'dm')
        return value * 0.01;
    if (base === 'km' && conversion === 'cm')
        return value * 0.00001;
    if (base === 'hm' && conversion === 'cm')
        return value * 0.0001;
    if (base === 'dam' && conversion === 'cm')
        return value * 0.001;
    if (base === 'm' && conversion === 'cm')
        return value * 0.01;
    if (base === 'dm' && conversion === 'cm')
        return value * 0.1;
    if (base === 'cm' && conversion === 'cm')
        return value * 1;
    if (base === 'mm' && conversion === 'cm')
        return value * 0.1;
    if (base === 'km' && conversion === 'mm')
        return value * 0.000001;
    if (base === 'hm' && conversion === 'mm')
        return value * 0.00001;
    if (base === 'dam' && conversion === 'mm')
        return value * 0.0001;
    if (base === 'm' && conversion === 'mm')
        return value * 0.001;
    if (base === 'dm' && conversion === 'mm')
        return value * 0.01;
    if (base === 'cm' && conversion === 'mm')
        return value * 0.1;
    if (base === 'mm' && conversion === 'mm')
        return value * 1;
    return 0;
}
